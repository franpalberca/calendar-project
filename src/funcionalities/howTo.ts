...
const createModalInfo = document.querySelector('#createModalInfo') as HTMLDivElement;
...
export function howToCreateEvents(): void {
	if (howToCreateEventsBtn) {
		howToCreateEventsBtn.addEventListener('click', () => {
			const modalEventHowToCreate = document.createElement('div') as HTMLDivElement;
